                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('matricno') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="matricno" type="matricno" class="form-control" name="matricno" value="{{ old('matricno') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('projectname') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="projectname" type="projectname" class="form-control" name="projectname" value="{{ old('projectname') }}" required>
